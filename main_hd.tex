...
at full intensity, and that NAFT recovers up to 0.28 F1 points
under this condition.
Emoji noise also shows substantial recovery under NAFT (+0.12 F1
at $\alpha=1.0$).
...
noise, recovering up to $\Delta F_1 = +0.28$ at $\alpha=0.3$
...
Even at full intensity ($\alpha=1.0$), NAFT achieves F1=0.3977
versus baseline 0.3333 (+0.064).

Emoji noise also benefits substantially from NAFT, improving from
0.7621 to 0.8798 at $\alpha=1.0$ (+0.118), with gains growing
...
\begin{table}[h]
  ...
  \end{tabular}
\end{table}
NAFT reduces clean-text F1 from 0.9119 to 0.9059 ($\Delta=-0.006$),
...
\begin{table}[h]
  ...
  \begin{tabular}{ccccr}
    ...
    \midrule
    Typographic & 0.0 & 0.9119 & 0.9059 & $-$0.006 \\
                & 0.1 & 0.7538 & 0.7960 & $+$0.042 \\
                & 0.2 & 0.5524 & 0.7420 & $+$0.190 \\
                & 0.3 & 0.3821 & 0.6658 & $+$0.284 \\
                & 0.4 & 0.3773 & 0.6115 & $+$0.234 \\
                & 0.5 & 0.3456 & 0.6028 & $+$0.257 \\
                & 0.6 & 0.3359 & 0.5572 & $+$0.221 \\
                & 0.7 & 0.3324 & 0.5191 & $+$0.187 \\
                & 0.8 & 0.3378 & 0.4534 & $+$0.116 \\
                & 0.9 & 0.3333 & 0.4439 & $+$0.111 \\
                & 1.0 & 0.3333 & 0.3977 & $+$0.064 \\
    \addlinespace
    Emoji       & 0.0 & 0.9119 & 0.9059 & $-$0.006 \\
                & 0.1 & 0.9060 & 0.9079 & $+$0.002 \\
                & 0.2 & 0.8938 & 0.9059 & $+$0.012 \\
                & 0.3 & 0.8798 & 0.9079 & $+$0.028 \\
                & 0.4 & 0.8856 & 0.9119 & $+$0.026 \\
                & 0.5 & 0.8593 & 0.8959 & $+$0.037 \\
                & 0.6 & 0.8487 & 0.8919 & $+$0.043 \\
                & 0.7 & 0.8207 & 0.8959 & $+$0.075 \\
                & 0.8 & 0.8194 & 0.8919 & $+$0.073 \\
                & 0.9 & 0.7983 & 0.8938 & $+$0.096 \\
                & 1.0 & 0.7621 & 0.8798 & $+$0.118 \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[h]
  ...
  \begin{tabular}{ccccr}
    ...
    \textbf{Noise} & $\alpha$ & \textbf{Base} & \textbf{NAFT} & $\Delta$ \\
    \midrule
    Abbrev. & 0.0 & 0.9119 & 0.9059 & $-$0.006 \\
            & 0.3 & 0.8920 & 0.8980 & $+$0.006 \\
            & 0.5 & 0.8820 & 0.8879 & $+$0.006 \\
            & 0.7 & 0.8800 & 0.8740 & $-$0.006 \\
            & 1.0 & 0.8760 & 0.8660 & $-$0.010 \\
    \addlinespace
    Slang   & 0.0 & 0.9119 & 0.9059 & $-$0.006 \\
            & 0.3 & 0.9140 & 0.9039 & $-$0.010 \\
            & 0.5 & 0.9020 & 0.8999 & $-$0.002 \\
            & 0.7 & 0.9080 & 0.8959 & $-$0.012 \\
            & 1.0 & 0.9000 & 0.8899 & $-$0.010 \\
    \addlinespace
    Punct.  & 0.0 & 0.9119 & 0.9059 & $-$0.006 \\
            & 0.3 & 0.9060 & 0.9020 & $-$0.004 \\
            & 0.5 & 0.9080 & 0.9000 & $-$0.008 \\
            & 0.7 & 0.9020 & 0.8920 & $-$0.010 \\
            & 1.0 & 0.8940 & 0.8900 & $-$0.004 \\
    \addlinespace
    Sarcasm & 0.0 & 0.9119 & 0.9059 & $-$0.006 \\
            & 0.3 & 0.9139 & 0.9138 & $-$0.000 \\
            & 0.5 & 0.9139 & 0.9198 & $+$0.006 \\
            & 0.7 & 0.9119 & 0.9278 & $+$0.016 \\
            & 1.0 & 0.9159 & 0.9298 & $+$0.014 \\
    \bottomrule
  \end{tabular}
\end{table}
...
collapse from 0.91 to 0.33), and NAFT recovers up to 0.28 F1
